...
def directional_movement_index(df):
  ...
  # シグナルとトレンド強度の判定
  df['adx_Signal'] = np.where(df['+DI14'] > df['-DI14'], 'Buy', 'Sell')
  df['adx_Trend_Strength'] = np.where(df['ADX'] >= 25, 'Strong', 'Weak')
  ...
  # 結果の表示
  # print(df[['+DI14', '-DI14', 'ADX', 'adx_Signal', 'adx_Trend_Strength']].tail(30))
...
def rsi(df):
  ...
  # plt.scatter(df[df['rsi_Signal'] == 'Buy'].index, df[df['rsi_Signal'] == 'Buy']['RSI'], marker='^', color='green', label='Buy Signal', s=100)
  # plt.scatter(df[df['rsi_Signal'] == 'Sell'].index, df[df['rsi_Signal'] == 'Sell']['RSI'], marker='v', color='red', label='Sell Signal', s=100)
...
def rci(df):
  ...
  # plt.axhline(70, color='red', linestyle='--')
  # plt.axhline(30, color='green', linestyle='--')
  # plt.scatter(df[df['rci_Signal'] == 'Buy'].index, df[df['rci_Signal'] == 'Buy']['RCI'], marker='^', color='green', label='Buy Signal', s=100)
  # plt.scatter(df[df['rci_Signal'] == 'Sell'].index, df[df['rci_Signal'] == 'Sell']['RCI'], marker='v', color='red', label='Sell Signal', s=100)
...
def madp(df):
  ...
  # plt.scatter(df[df['madp_Signal'] == 'Buy'].index, df[df['madp_Signal'] == 'Buy']['madp'], marker='^', color='green', label='Buy Signal', s=100)
  # plt.scatter(df[df['madp_Signal'] == 'Sell'].index, df[df['madp_Signal'] == 'Sell']['madp'], marker='v', color='red', label='Sell Signal', s=100)
...
def stochastic(df):
  ...
  # plt.scatter(df[df['sto_Signal'] == 'Buy'].index, df[df['sto_Signal'] == 'Buy']['slow%D'], marker='^', color='green', label='Buy Signal', s=100)
  # plt.scatter(df[df['sto_Signal'] == 'Sell'].index, df[df['sto_Signal'] == 'Sell']['slow%D'], marker='v', color='red', label='Sell Signal', s=100)
...
def mfi(df):
  ...
  # plt.axhline(80, color='red', linestyle='--')
  # plt.axhline(20, color='green', linestyle='--')
  # plt.scatter(df[df['mfi_Signal'] == 'Buy'].index, df[df['mfi_Signal'] == 'Buy']['MFI'], marker='^', color='green', label='Buy Signal', s=100)
  # plt.scatter(df[df['mfi_Signal'] == 'Sell'].index, df[df['mfi_Signal'] == 'Sell']['MFI'], marker='v', color='red', label='Sell Signal', s=100)
...
def cci(df):
  ...
  # plt.scatter(df[df['cci_Signal'] == 'Buy'].index, df[df['cci_Signal'] == 'Buy']['CCI'], marker='^', color='green', label='Buy Signal', s=100)
  # plt.scatter(df[df['cci_Signal'] == 'Sell'].index, df[df['cci_Signal'] == 'Sell']['CCI'], marker='v', color='red', label='Sell Signal', s=100)
...
def hv(df):
  ...
  # plt.scatter(df[df['hv_Signal'] == 'Buy'].index, df[df['hv_Signal'] == 'Buy']['RCI'], marker='^', color='green', label='Buy Signal', s=100)
  # plt.scatter(df[df['hv_Signal'] == 'Sell'].index, df[df['hv_Signal'] == 'Sell']['RCI'], marker='v', color='red', label='Sell Signal', s=100)
...
for i, stock_data in enumerate(stock_list):
  ...
  if len(df) == 0 or 'symbol' not in df.columns:
    continue
  file_name = str(df['symbol'][0]) + '.parquet'
  ...
  df.to_parquet(dm_fol+file_name)
  shutil.move(stock_data, arc_fol)